...
{
    public const string ProjectNameRequired = "Projects name is required.";
    public const string ManagerIdRequired = "Manager ID is required.";
    public const string StartDateFutureLimit = "Start date cannot be more than 1 year in the future.";
